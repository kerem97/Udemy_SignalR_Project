...
using SignalR.Web.UI.Dtos.NotificationDtos;
using System.Text;
...
namespace SignalR.Web.UI.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7294/api/Notification/NotificationStatusChangeToTrue/{id}");
            return RedirectToAction("Index");
        }
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync($"https://localhost:7294/api/Notification/NotificationStatusChangeToFalse/{id}");
            return RedirectToAction("Index");
        }
